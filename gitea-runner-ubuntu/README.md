...
|-------------------------------------|----------------------------|-------------------------------------------------------------------------------------------|----------------------------------------------------|----------------------------------------------------------------------------|
| `gitea-runner-ubuntu`               | `Dockerfile`               | Ubuntu 26.04 + Docker 28.5.2 + Gitea Runner 1.0.8 + Node.js 24.18.0 + Python 3 + 常用工具 | `ubuntu-latest,ubuntu-26.04`                       | `ubuntu-aarch64-latest,ubuntu-aarch64-26.04`                               |
...
| `gitea-runner-ubuntu-flutter`       | `Dockerfile.flutter`       | + Flutter 3.44.2 + Android SDK (compileSdk 36, NDK 29, build-tools 36) + OpenJDK 21       | `ubuntu-latest,ubuntu-26.04,ubuntu-flutter`        | 仅 x86_64                                                                  |
