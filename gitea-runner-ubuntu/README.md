...
|-------------------------------------|----------------------------|--------------------------------------------------------------------------------------------------------------|----------------------------------------------------|----------------------------------------------------------------------------|
| `gitea-runner-ubuntu`               | `Dockerfile`               | Ubuntu 26.04 + Docker 28.5.2 + Gitea Runner 4.0.0 + Node.js 24.21.0 + Qwen Code 0.24.5 + Python 3 + 常用工具 | `ubuntu-latest,ubuntu-26.04`                       | `ubuntu-aarch64-latest,ubuntu-aarch64-26.04`                               |
...
基础镜像通过 npm 全局安装 Qwen Code CLI（当前 `0.24.5`，可用构建参数
