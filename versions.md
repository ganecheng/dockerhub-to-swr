...
|---------|---------------------|-----------|----------------------|----------------------|----------------------|-------------------|-------------------|
| ComfyUI | `Comfy-Org/ComfyUI` | `v0.36.0` | `v0.36.0` (已是最新) | `v0.36.0` (已是最新) | `v0.36.0` (已是最新) | `comfyui/code.sh` | AI 图像生成工作流 |
...
> 下游 Dockerfile 通过 timestamp tag 硬编码引用上游镜像（如 `20260914_212511`）。
